...
var bio = {
  ...
  " Since then, Jean-Michel has been working on a number of high business profile projects <br>" +
  " 2 main business context: Insurance and Clearing & Custody. <br> ",
  ...
  projects: [
    {
      title: "new sesame",
      dates: "2014-present",
      description: "Reengineering of the sales tools for bank tellers selling insurance products - Target 2 major retail banking actors in France",
      images: []
    },
    {
      title: "acetp",
